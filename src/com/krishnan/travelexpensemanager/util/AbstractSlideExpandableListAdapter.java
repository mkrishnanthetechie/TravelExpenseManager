	...
	private void notifiyExpandCollapseListener(int type, View view, int position) {
		if (expandCollapseListener != null) {
			if (type == ExpandCollapseAnimation.EXPAND) {
				LinearLayout expandableLayout = (LinearLayout) view;
				TextView dynamic_Text = (TextView)expandableLayout.getChildAt(0);
				dynamic_Text.setText("Selected position: " + position);
